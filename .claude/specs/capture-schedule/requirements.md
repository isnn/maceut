...
- [ ] Validasi: user tidak boleh memiliki lebih dari 10 active schedule (BR-005)
...
**Edge Cases:**
- User sudah punya 10 active schedule → tombol "Buat Schedule" disabled + tooltip "Batas 10 schedule aktif tercapai"
...
- [ ] Schedule yang di-pause tidak dihitung dalam limit 10 active (BR-005)
...
- Resume schedule saat sudah ada 10 active schedule lain → return 422 SCHEDULE_LIMIT_EXCEEDED
