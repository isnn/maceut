...
| ADR-009 | Better Auth + HttpOnly JWT | HttpOnly cookie mencegah XSS; Better Auth simplifikasi setup session; tidak perlu refresh token logic manual | Tidak stateless murni; perlu session store atau token blacklist saat logout |
